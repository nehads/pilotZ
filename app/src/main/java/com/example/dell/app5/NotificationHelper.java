...
public class NotificationHelper extends ContextWrapper {
    ...
    public Notification.Builder getPilotChannelNotification(String phonumNumberEmail){
        Intent resultIntent = new Intent(this, displayDetails.class);
        resultIntent.putExtra("data", phonumNumberEmail);
        Uri alarmSound = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_ALL);

        PendingIntent resultPendingIntent = PendingIntent.getActivity(this, 1, resultIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        return new Notification.Builder(getApplicationContext(), CHANNEL_ID)
                .setContentText("New customer request!")
